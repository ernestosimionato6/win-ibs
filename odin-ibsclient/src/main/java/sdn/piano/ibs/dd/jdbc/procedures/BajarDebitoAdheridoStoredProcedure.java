...
public class BajarDebitoAdheridoStoredProcedure extends StoredProcedure {

private static final String PROCEDURE_NAME = "sgl_ebfBaja_DebAut";

public BajarDebitoAdheridoStoredProcedure(DataSource dataSource) {
