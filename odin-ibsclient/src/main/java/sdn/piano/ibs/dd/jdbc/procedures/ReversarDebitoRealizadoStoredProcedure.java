...
public class ReversarDebitoRealizadoStoredProcedure extends StoredProcedure {

private static final String PROCEDURE_NAME = "sgl_ebfReversa_DebAut";

public ReversarDebitoRealizadoStoredProcedure(DataSource dataSource) {
...
public IBSTramite execute(String id) throws Exception {
  Map<String, Object> in = new HashMap<String, Object>();
  in.put("id", new BigDecimal(id));
