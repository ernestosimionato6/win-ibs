...
public class IBSDDBajarDebitoAdheridoCommand {

IBSDDClient client;

public IBSDDBajarDebitoAdheridoCommand(IBSDDClient client) {
  this.client = client;
}

public Optional<Tramite> bajarDebitoAdherido(String tipoCuenta, String nroCuenta, String idAdhesion) throws Exception {
  return Optional.of(client.bajarDebitoAdherido(
	IBSDDBajarDebitoAdheridoRequest.of(idAdhesion)	
  ).tramite); 
}

public static void main(String args[]) throws Exception {
 if(args.length<2) throw new RuntimeException("debe informar el id de adhesion y la cuenta asociada.  \n" + HELP);
 String tipoCuenta = args[0]; String nroCuenta = args[1]; String idAdhesion = args[2];

 System.out.println("..................... ibs_bajar_debito_adherido " + idAdhesion + " .... " + nroCuenta + " ..... " + tipoCuenta);

 IBSDDBajarDebitoAdheridoCommand ctx = new IBSDDBajarDebitoAdheridoCommand(new IBSDDClientImpl(
    loadConfig("ibs_config.properties")
 ));

 Optional<Tramite> tramite = ctx.bajarDebitoAdherido(tipoCuenta, nroCuenta, idAdhesion);
...
"Usage: sdn_ibs_dd bajar_debito_adherido <id_adhesion> <tipo_cuenta> <nro_cuenta> \n\n" +
